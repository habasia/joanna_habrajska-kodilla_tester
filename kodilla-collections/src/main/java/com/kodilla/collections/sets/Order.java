...
public class Order {
    ...
    public boolean equals(Object o) {
        ...
        Order order = (Order) o;
        return Double.compare(order.getQuantity(), getQuantity()) == 0 && Objects.equals(getOrderNumber(), order.getOrderNumber()) && Objects.equals(getProductName(), order.getProductName());
    }
